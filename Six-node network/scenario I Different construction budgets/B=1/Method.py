...
class Solve:
    def __init__(self):
        ...
        self.g_number_of_links, self.g_number_of_nodes, self.g_number_of_charging_stations, self.g_number_of_ODs=data.read_candidate_charging_stations()

        self.construction_budget=1  #0-1-2
        self.construction_cost=1
        self.electric_quantity=2
...
### flag: generalized routing cost
            ...
            if flag==2:
                if element.Primal_label_cost<self.state_vector[state_index].Primal_label_cost:
                    self.state_vector[state_index]=element
...
### flag: generalized routing cost
    def Sort(self,flag):
        ...
        if flag==2:
            self.state_vector=sorted(self.state_vector,key=lambda x:x.Primal_label_cost)
